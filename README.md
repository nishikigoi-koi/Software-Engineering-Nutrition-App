...
3. Run `cd ./Node ; npm start` inside of your terminal to start the API server in background (to stop it press ctrl + c).
4. Run `cd ..` to get back to main directory
...
Waiting for connection from debug service on Chrome...             17.0s
```
